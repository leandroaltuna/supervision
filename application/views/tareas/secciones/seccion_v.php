	<div class="box-body">
		<h3 class="page-header">V. Consecución de Locales de capacitación y preselección</h3>
	<?php
		$attributes = array('id' => 'frm_sec_5', 'name' => 'frm_sec_5', 'role' => 'form-horizontal' );
	...
	?>
			<div class="row form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="A_5_1_INSTITUCION" name="A_5_1_INSTITUCION" placeholder="Nombre de la Institucion que cedio local" class="form-control">
					<div class="help-block error"></div>
				</div>
				<div class="col-sm-1">
			...
			<div class="row form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="A_5_3_INSTITUCION" name="A_5_3_INSTITUCION" placeholder="Nombre de la Institucion que cedio local" class="form-control">
					<div class="help-block error"></div>
				</div>
				<div class="col-sm-1">
			...
			<div class="row form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="A_5_5_INSTITUCION" name="A_5_5_INSTITUCION" placeholder="Nombre de la Institucion que cedio local" class="form-control">
					<div class="help-block error"></div>
				</div>
				<div class="col-sm-1">
			...
			<div class="row form-group">
				...
				<div class="col-sm-4">
					<input type="text" id="A_5_7_INSTITUCION" name="A_5_7_INSTITUCION" placeholder="Nombre de la Institucion que cedio local" class="form-control">
					<div class="help-block error"></div>
				</div>
				<div class="col-sm-1">
			...
			$('#frm_sec_5').validate({
					...
					submitHandler: function(form)
					{
						...
						form_data.push( 
							...
							{ name: 'seccion', value: 5 }
						);
						
						$.ajax({
							// url: CI.site_url + '/verificacion_tareas/save_seccion_5',
