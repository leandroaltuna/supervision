	<div class="box-body">
		...
		<h4 class="page-header">XII. Verificación del Simulacro</h4>
	<?php
		$attributes = array('id' => 'frm_sec_12', 'name' => 'frm_sec_12', 'role' => 'form-horizontal' );
			...
			$('#frm_sec_12').validate({
					...
					submitHandler: function(form)
					{
						...
						form_data.push( 
							...
							{ name: 'seccion', value: 12 }
						);
						
						$.ajax({
							// url: CI.site_url + '/verificacion_tareas/save_simulacro',
